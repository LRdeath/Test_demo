...
import com.example.administrator.text1.test_designsupport.Test_FloatButton;
        ...
        switch (v.getId()){
            case R.id.btn_plus_menu:
                ...
                getSupportFragmentManager().beginTransaction()
                        .setCustomAnimations(R.anim.anim_translate,R.anim.anim_translate,R.anim.anim_translate,R.anim.anim_translate)
            ...
            case R.id.plus_menu_bottom4:
                Intent i = new Intent(Test_Bottommenu.this, Test_FloatButton.class);
                startActivity(i);
                break;
        }
    }
