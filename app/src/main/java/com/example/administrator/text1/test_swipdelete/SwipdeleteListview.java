 ...
 */
public class SwipdeleteListview extends ListView {
    ...
    public SwipdeleteListview(Context context) {
        this(context, null);
    }

    public SwipdeleteListview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipdeleteListview(Context context, AttributeSet attrs, int defStyleAttr) {
